function [fk,d] = frameFDM3(c0,Fs,f_min,f_max,k_max)
%Memory crash may occur for some version of MATLAB, please use the mex file
...
%---------equation (25)----------------
    ...
    %%
    Y1(isnan(Y1)) = 1;        %new added
    Y1(isinf(Y1)) = 1;        %new added
    Y0(isnan(Y0)) = 0;        %new added
    Y0(isinf(Y0)) = 0;        %new added
%     if(isnan(Y1)==1)
%         Y1 = 1;
%     end
%     if(isnan(Y0)==1)
