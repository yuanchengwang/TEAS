...
%                     transitionCost(n,y,i) = 0;
                    ...
                    if abs(log2(f0Candidates(n,i)/f0Candidates(y,i+1)))<=2.5/12
                        transitionCost(n,y,i) = normpdf(abs(log2(f0Candidates(n,i)/f0Candidates(y,i+1))),0,0.5)+(w*f0CandidatesWeights(n,i));
                    else
                        transitionCost(n,y,i) =w*f0CandidatesWeights(n,i);
                    end
                end%var=2.5 by default
            end
        end
    end
