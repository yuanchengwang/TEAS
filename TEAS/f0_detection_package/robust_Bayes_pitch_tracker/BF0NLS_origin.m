function result=BF0NLS_origin(speechSignal,samplingFreq,plot_flag,prew_flag,Par_set)
% -----------------------------------------------------------------------
...
if isempty(Par_set)
    ...
    segmentShift =0.01; %0.010 seconds(original),about 3 times , the same as that of pYIN!!!!!!
    f0Bounds = [70, 400]; % [70,400] cycles/sample!!!!!!!
    std_pitch=2;%2 original
else
